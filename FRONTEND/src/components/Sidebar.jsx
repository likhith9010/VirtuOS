...
function Sidebar({ isOpen, onToggle, chats, activeChat, onNewChat, onSwitchChat, onDeleteChat, onSettingsClick }) {
    ...
    <div className={`${isOpen ? 'w-64' : 'w-20'} bg-white border-r border-gray-200 flex flex-col transition-all duration-300`}>
          ...
          {isOpen ? (
            <>
              ...
              <button 
                ...
                className={`text-gray-400 hover:text-gray-600 transition-colors ${isSearchOpen ? 'text-orange-500' : ''}`}
              >
        ...
        {isOpen && isSearchOpen && (
          <div className="mt-3 relative">
            <input
              ...
              className="w-full px-3 py-2 pl-9 bg-gray-100 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              autoFocus
            />
      ...
      <div className="p-4 border-t border-gray-100">
        <button 
          ...
          className={`w-full flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} text-gray-700 hover:bg-orange-50 rounded-lg px-3 py-2.5 transition-colors`}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
